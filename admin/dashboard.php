...
<?php 
$sql4 ="SELECT author_name from book_authors ";
...
?>
                 ...
                 <div class="col-md-6 col-sm-2 rscol-xs-5">
                      <div class="alert alert-info back-widget-set text-center">
...
<div class="col-md-12 col-sm-2 rscol-xs-5">
                      <div class="alert alert-info back-widget-set text-center">
